...
source("code/helper scripts/compute_optimum.R")
...
# find best performing variable without country effects
...
gam_analysis(df = df_wnnd_filtered, predictor = "temp_4mo_avg_pop_weight",
             country_effects = F)
gam_analysis(df = df_wnnd_filtered, predictor = "temp_3mo_avg_pop_weight",
                              country_effects = F)

# fit with best performing variable and country effects
...
compute_optimum(df = df_wnnd_filtered, model = temp_analysis$model, 
                predictor= "temp_3mo_avg_pop_weight", country_id ="EL")
...
compute_optimum(df = df_wnnd_filtered, model = temp_analysis_adjusted$model, 
                predictor= "temp_3mo_avg_pop_weight", country_id ="EL")
...
gam_analysis(df = df_wnnd_filtered, predictor = "r0_from_seasonal_4mo_avg_pop_weight",
             k_shared = 10, country_effects = F)
gam_analysis(df = df_wnnd_filtered, predictor = "r0_from_seasonal_3mo_avg_pop_weight",
             k_shared = 10, country_effects = F)
...
temp_plots$model_plot

ggsave("figures/monthly/Figure_5.tiff",
       plot = temp_plots$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       dpi = 600, units = "in", compression = "lzw")
ggsave("figures/monthly/Figure_5.svg",
       plot = temp_plots$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       units = "in")

temp_plots_adjusted$model_plot

ggsave("figures/monthly/Figure_S3.tiff",
       plot = temp_plots_adjusted$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       dpi = 600, units = "in", compression = "lzw")
ggsave("figures/monthly/Figure_S3.svg",
       plot = temp_plots_adjusted$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       units = "in")
...
ggsave("figures/monthly/Figure_S4.tiff",
       plot = R0_from_seasonal_plots$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       dpi = 600, units = "in", compression = "lzw")
ggsave("figures/monthly/Figure_S4.svg",
       plot = R0_from_seasonal_plots$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       units = "in")

R0_from_seasonal_plots_adjusted$model_plot

ggsave("figures/monthly/Figure_S5.tiff",
       plot = R0_from_seasonal_plots_adjusted$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       dpi = 600, units = "in", compression = "lzw")
ggsave("figures/monthly/Figure_S5.svg",
       plot = R0_from_seasonal_plots_adjusted$model_plot,
       bg = "white",
       width = 6.2, height = 7,
       units = "in")
