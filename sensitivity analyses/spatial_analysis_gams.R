...
df_wnnd_aggr <- df_wnnd_2010_2023 %>%
  group_by(NUTS_ID) %>%
...
df_wnnd_aggr$wnnd_sum <- round(df_wnnd_aggr$wnnd_sum)
df_wnnd_aggr$population <- round(df_wnnd_aggr$population)
# total incidence over the period
df_wnnd_aggr$incidence_per_100K <- 100000*df_wnnd_aggr$wnnd_sum/(df_wnnd_aggr$population)

df_wnnd_aggr <- df_wnnd_aggr %>%
...
temp_analysis <- gam_analysis(df_wnnd_aggr, 
                              "temp_summer", upper_k = 15)

temp_plots <- plot_gam_f(df_wnnd_aggr, temp_analysis$model, "temp_summer", 
                         n_bins = 20, type = "spatial") 
...
temp_binary_analysis <- gam_analysis(df_wnnd_aggr, 
                                     "temp_summer", binary = T, upper_k = 15)
temp_binary_plots <- plot_gam_f(df_wnnd_aggr,
                                temp_binary_analysis$model, "temp_summer",
                                binary = T, n_bins = 20, type = "spatial")
...
R0_from_daily_analysis <- gam_analysis(df_wnnd_aggr, "r0_from_daily_summer",
                                       upper_k = 15)
R0_from_daily_plots <- plot_gam_f(df_wnnd_aggr,
                                  R0_from_daily_analysis$model,
                                  "r0_from_daily_summer", type = "spatial",
                                  r0_predictor = T, n_bins = 20)
...
R0_from_monthly_analysis <- gam_analysis(df_wnnd_aggr, "r0_from_monthly_summer",
                                         upper_k = 15)
R0_from_monthly_plots <- plot_gam_f(df_wnnd_aggr,
                                    R0_from_monthly_analysis$model,
                                    "r0_from_monthly_summer", type = "spatial",
                                    r0_predictor = T, n_bins = 20)
...
R0_from_seasonal_analysis <- gam_analysis(df_wnnd_aggr, "r0_from_seasonal_summer",
                                          upper_k = 15)
R0_from_seasonal_plots <- plot_gam_f(df_wnnd_aggr,
                                     R0_from_seasonal_analysis$model,
                                     "r0_from_seasonal_summer", type = "spatial",
                                     r0_predictor = T, n_bins = 20)
...
R0_from_daily_gridded_analysis <- gam_analysis(df_wnnd_aggr,
                                               "r0_from_daily_summer_native",
                                               upper_k = 15)
R0_from_daily_gridded_plots <- plot_gam_f(df_wnnd_aggr,
...
R0_from_monthly_gridded_analysis <- gam_analysis(df_wnnd_aggr,
                                                 "r0_from_monthly_summer_native",
                                                 upper_k = 15)
R0_from_monthly_gridded_plots <- plot_gam_f(df_wnnd_aggr,
...
R0_from_seasonal_gridded_analysis <- gam_analysis(df_wnnd_aggr,
                                                  "r0_from_seasonal_summer_native",
                                                  upper_k = 15)
R0_from_seasonal_gridded_plots <- plot_gam_f(df_wnnd_aggr,
...
ggsave(".../main_gam_plot_spatial.tiff", 
       plot = plot_grid1,
       bg = "white",
       width = 8, height = 6, 
...
ggsave(".../r0_gam_plot_spatial.tiff", 
       plot = plot_grid2,
       width = 8, height = 9, 
       dpi = 300, units = "in", compression = "lzw")
...
ggsave(".../r0_gam_plot_native_spatial.tiff", 
       plot = plot_grid3,
       width = 8, height = 9, 
       dpi = 300, units = "in", compression = "lzw")
